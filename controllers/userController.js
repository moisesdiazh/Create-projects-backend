...
const register = async (req, res) => {
    ...
    try {
        ...
        res.json(userSave); //respuesta una vez se cree el usuario

        // console.log(user); para ver que llega
    }catch (error) { //colocamos un catch para debuguear en caso de error
        console.log(error);
    }
...
const confirmToken = async(req, res) => { //confirmamos el token del usuario
    ...
    if(!userConfirm) { //vemos que el usuario no esta confirmado
...
export {register, auth, confirmToken, olvidePassword, confirmTokenPassword, newPassword, profile};